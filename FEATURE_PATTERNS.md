...
- Last resort: a tagged placeholder service (`https://loremflickr.com/<w>/<h>/<tag>`). These return random matches and degrade visual quality; only use when Unsplash is unavailable for the whole subject.
